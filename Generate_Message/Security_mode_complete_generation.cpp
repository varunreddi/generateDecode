...
int main(int argc, char *argv[])
{
    ...
    switch(i)
    {
        case 1:
        {
            data = ng.generate_security_mode_complete_1();
            break;
        }

    case 2:
        {
            //data = ng.generate_security_mode_complete_2();
            break;
        }
        case 3:
        {
           // data = ng.generate_security_mode_complete_3();
            break;
        }
        default:
            break;
    }
    std::cout<<"Security mode complete \n----------------------------------------------------- \n"<<dump_wireshark(data)<<"\n"<<std::endl;
